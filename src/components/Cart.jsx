              ...
              <div className="p-1 items-center flex justify-between">
                <div className="">
                  ...
                  <p className="text-green-500">₹{" "}
                    ...
                    <div className="text-sm w-3/12 h-10 text-gray-500 overflow-hidden text-ellipsis">{element.description}</div>
                </div>
                ...
                <div className="item-center">
                  ...
                  />
                  <button className='mx-4 rounded-md shadow-md bg-red-400 p-1 mt-2'onClick={()=>{handledelete(index)}}>Remove</button>
                </div>
              </div>
            </div>
          ))}
